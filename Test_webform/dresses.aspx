<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dresses.aspx.cs" Inherits="Test_webform.dresses" %>
...
<div class="grid-wrapper">
  ...
  <div class="grid-container">
    <div class="grid-item">
        <img src="dresses/Aurora Amount Dress.jpeg" alt="Image 1">
        <div class="label">Aurora Amount Dress
        </div>
        <br><br><br>
    ...
    <div class="grid-item">
        <img src="dresses/Azure Skies Corset Charm Dress.jpeg" alt="Image 2">
        <div class="label">Azure Skies Corset Charm Dress</div><br>
        <div class="label">₱6,899.00</div>
    </div>
    <div class="grid-item">
        <img src="dresses/Barbie Blush Bombshell Dress.jpeg" alt="Image 3">
        <div class="label">Barbie Blush Bombshell Dress</div><br>
        <div class="label">₱6,899.00</div>
    </div>
    <!--<div class="grid-item">
