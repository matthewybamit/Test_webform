...
<form id="form1" runat="server">
    ...
    <asp:ImageButton ID="Gcash" ImageUrl="gcash.png" runat="server" OnClick="btnGcash_Click" style="width: 150px; height: 60px; background-size: cover; object-fit: contain; border-radius: 10px;"/>
</form>
