...
namespace Test_webform
{
    public partial class WebForm2 : System.Web.UI.Page
    {
        ...
        protected void PopulateGridContainer()
        {
            ...
            {
                // Update the SQL query to fetch products with specified categories
                string query = "SELECT PRODUCT_NAME, PRODUCT_PRICE, PRODUCT_IMG FROM PRODUCTS WHERE PRODUCT_CATEGORY IN ('debut', 'dress', 'wedding')";
